...
const defaultPlans: Plan[] = [
  {
    id: 'push', name: 'Push Day', focus: 'Chest, shoulders & triceps', duration: '55 min',
    blocks: [
      { id: 'push-strength', name: 'Primary strength', focus: 'Heavy compound work', rounds: 4 },
      { id: 'push-volume', name: 'Upper-body volume', focus: 'Controlled hypertrophy work', rounds: 3 },
      { id: 'push-finish', name: 'Tricep finisher', focus: 'Finish with clean reps', rounds: 3 },
    ],
    exercises: [
      { id: 'bench', blockId: 'push-strength', name: 'Barbell Bench Press', sets: 4, reps: '6-8', cue: 'Pin your shoulder blades back, plant your feet, and keep wrists stacked over elbows.' },
      { id: 'ohp', blockId: 'push-strength', name: 'Overhead Press', sets: 4, reps: '8-10', cue: 'Brace your core and glutes. Keep ribs down and move your head through at the top.' },
      { id: 'incline', blockId: 'push-volume', name: 'Incline Dumbbell Press', sets: 3, reps: '8-12', cue: 'Use a low incline, keep elbows near 45 degrees, and control the stretch.' },
      { id: 'lateral', blockId: 'push-volume', name: 'Lateral Raise', sets: 3, reps: '12-15', cue: 'Lead with your elbows, keep traps relaxed, and stop around shoulder height.' },
      { id: 'tricep', blockId: 'push-finish', name: 'Cable Tricep Pushdown', sets: 3, reps: '10-15', cue: 'Lock elbows by your sides and fully straighten without leaning into the cable.' },
    ],
  },
  {
    id: 'pull', name: 'Pull Day', focus: 'Back, rear delts & biceps', duration: '60 min',
    blocks: [
      { id: 'pull-strength', name: 'Heavy pull', focus: 'Brace and move with intent', rounds: 4 },
      { id: 'pull-volume', name: 'Back volume', focus: 'Build controlled pulling volume', rounds: 3 },
      { id: 'pull-finish', name: 'Arms finisher', focus: 'Strict reps without momentum', rounds: 3 },
    ],
    exercises: [
      { id: 'deadlift', blockId: 'pull-strength', name: 'Deadlift', sets: 4, reps: '5', cue: 'Breathe and brace before lifting. Tighten your core and glutes, push the floor away, and keep the bar close.' },
      { id: 'pulldown', blockId: 'pull-strength', name: 'Pull-up / Lat Pulldown', sets: 4, reps: '6-10', cue: 'Pull your shoulder blades down first. Drive elbows toward your pockets without swinging.' },
      { id: 'row', blockId: 'pull-volume', name: 'Barbell Row', sets: 3, reps: '8-10', cue: 'Hinge and brace, keep a neutral spine, then pull toward your lower ribs.' },
      { id: 'facepull', blockId: 'pull-volume', name: 'Face Pull', sets: 3, reps: '12-15', cue: 'Pull toward your eyebrows and rotate thumbs behind you. Do not shrug.' },
      { id: 'curl', blockId: 'pull-finish', name: 'Dumbbell Curl', sets: 3, reps: '10-12', cue: 'Keep elbows still, avoid momentum, and lower each rep for two seconds.' },
    ],
  },
  {
    id: 'legs', name: 'Leg Day', focus: 'Quads, hamstrings & glutes', duration: '60 min',
    blocks: [
      { id: 'legs-strength', name: 'Lower-body strength', focus: 'Heavy bilateral patterns', rounds: 4 },
      { id: 'legs-volume', name: 'Leg volume', focus: 'Controlled unilateral work', rounds: 3 },
      { id: 'legs-finish', name: 'Calves & core', focus: 'Finish strong and stable', rounds: 3 },
    ],
    exercises: [
      { id: 'squat', blockId: 'legs-strength', name: 'Barbell Back Squat', sets: 4, reps: '6-8', cue: 'Take a deep brace, keep your whole foot planted, and drive knees in line with toes.' },
      { id: 'rdl', blockId: 'legs-strength', name: 'Romanian Deadlift', sets: 4, reps: '8-10', cue: 'Soften your knees, push hips back, keep lats tight, and stop when hamstrings limit you.' },
      { id: 'legpress', blockId: 'legs-volume', name: 'Leg Press', sets: 3, reps: '10-12', cue: 'Keep your lower back against the pad and use the deepest range you can control.' },
      { id: 'split', blockId: 'legs-volume', name: 'Bulgarian Split Squat', sets: 3, reps: '8-10', cue: 'Keep your front foot planted, descend under control, and drive through the mid-foot.' },
      { id: 'calf', blockId: 'legs-finish', name: 'Standing Calf Raise', sets: 3, reps: '12-15', cue: 'Pause in the stretched position and squeeze at the top. Avoid bouncing.' },
      { id: 'plank', blockId: 'legs-finish', name: 'Plank', sets: 3, reps: '45 sec', cue: 'Squeeze your glutes, brace as if taking a punch, and keep a straight line from shoulders to heels.', timed: true, defaultSeconds: 45 },
    ],
  },
]
